...
namespace AppStream.Azure.WebJobs.Extensions.DurableTask
{
    public interface IFanInFanOut
    {
        ...
        Task<FanInFanOutResult<TBatchResult>> FanInFanOutAsync<TItem, TBatchResult>(
        ...
        /// <param name="options">Fan-in-fan-out configuration.</param>
        /// <returns>Results of all ran activities.</returns>
        Task<FanInFanOutResult<TBatchResult>> FanInFanOutAsync<TItem, TBatchResult, TDep1>(
            IDurableOrchestrationContext context,
            IEnumerable<TItem> items,
        ...
        /// <param name="options">Fan-in-fan-out configuration.</param>
        /// <returns>Results of all ran activities.</returns>
        Task<FanInFanOutResult<TBatchResult>> FanInFanOutAsync<TItem, TBatchResult, TDep1, TDep2>(
            IDurableOrchestrationContext context,
            IEnumerable<TItem> items,
        ...
        /// <param name="options">Fan-in-fan-out configuration.</param>
        /// <returns>Results of all ran activities.</returns>
        Task<FanInFanOutResult<TBatchResult>> FanInFanOutAsync<TItem, TBatchResult, TDep1, TDep2, TDep3>(
            IDurableOrchestrationContext context,
            IEnumerable<TItem> items,
        ...
        /// <param name="options">Fan-in-fan-out configuration.</param>
        /// <returns>Results of all ran activities.</returns>
        Task<FanInFanOutResult<TBatchResult>> FanInFanOutAsync<TItem, TBatchResult, TDep1, TDep2, TDep3, TDep4>(
            IDurableOrchestrationContext context,
            IEnumerable<TItem> items,
        ...
        /// <param name="options">Fan-in-fan-out configuration.</param>
        /// <returns>Results of all ran activities.</returns>
        Task<FanInFanOutResult<TBatchResult>> FanInFanOutAsync<TItem, TBatchResult, TDep1, TDep2, TDep3, TDep4, TDep5>(
            IDurableOrchestrationContext context,
            IEnumerable<TItem> items,
        ...
        /// <param name="options">Fan-in-fan-out configuration.</param>
        /// <returns>Results of all ran activities.</returns>
        Task<FanInFanOutResult<TBatchResult>> FanInFanOutAsync<TItem, TBatchResult, TDep1, TDep2, TDep3, TDep4, TDep5, TDep6>(
            IDurableOrchestrationContext context,
            IEnumerable<TItem> items,
        ...
        /// <param name="options">Fan-in-fan-out configuration.</param>
        /// <returns>Results of all ran activities.</returns>
        Task<FanInFanOutResult<TBatchResult>> FanInFanOutAsync<TItem, TBatchResult, TDep1, TDep2, TDep3, TDep4, TDep5, TDep6, TDep7>(
            IDurableOrchestrationContext context,
            IEnumerable<TItem> items,
